...
/**
 * Check status of Provisioned plans.
 */
public class ProvisionedPlan extends DirectoryObject {

    public final SimpleStringProperty capabilityStatus = new SimpleStringProperty();
    public final SimpleStringProperty provisioningStatus = new SimpleStringProperty();
